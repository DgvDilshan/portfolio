            ...
            <Fadein delay={100}>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-lg text-white/60 max-w-2xl mx-auto'>
                        A comprehensive overview of my technical skills and proficiencies across various domains in software development.
                    </p>
                </div>
            </Fadein>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
                {Object.entries(skillCategories).map(([category, categorySkills], categoryIndex) => (
                    <Fadein key={category} delay={categoryIndex * 100}>
                        <div className='relative bg-white/5 border border-white/10 rounded-2xl hover:border-primary/30 transition-all duration-300 group p-6'>
                                    ...
                                    return (
                                        <div key={skill.id} className='space-y-2'>
                                            ...
                                            <div className='relative h-1.5 bg-white/5 rounded-full overflow-hidden'>
                                                <div
                                                    className='absolute top-0 left-0 h-full bg-linear-to-r from-primary to-primary/80 rounded-full transition-all duration-1000 ease-out'
