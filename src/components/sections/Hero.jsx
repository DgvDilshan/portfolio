      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
             ...
             <div className='text-left'>
              ...
              <Fadein delay={200}>
                <p className='text-ld text-white/70 max-w-[550px] mb-8'>
                  Building modern and responsive web applications with React, JavaScript, and cutting-edge technologies. Transforming ideas into exceptional digital experiences.
                </p>
              </Fadein>
