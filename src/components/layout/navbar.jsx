        ...
        >
            ...
            >
                <div className='bg-black/95 backdrop-blur-lg border-t border-white/10 px-5 py-6 space-y-3'>
                    {NAV_LINKS.map(link => (
                        <button
                            ...
                            className={`block w-full text-left px-4 py-3 rounded-lg font-medium transition-all duration-300 ${activeSection === link.id
                                ...
                                : 'text-white/70 hover:text-white bg-transparent hover:bg-white/05'
                                }`}
                        >
                            {link.label}
                        </button>
                    ...
                    <button
                        onClick={() => handleNavClick('contact')}
                        className="w-full px-7 py-3.5 bg-white text-[#212121] font-medium text-base rounded-[17px] border-white hover:bg-white/90 transition-all duration-300 m-2"
                    >
                        Hire Me
                    </button>
