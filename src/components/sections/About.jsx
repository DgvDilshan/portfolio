                    ...
                    <div className='flex flex-col gap-8'>
                        ...
                        <Fadein delay={100}>
                            <h2 className='text-4xl lg:text-5xl font-normal text-white leading-tight'>
                                Crafting Digital Experiences with React.js
                            </h2>
                        </Fadein>
                ...
                <Fadein delay={200}>
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='col-span-2 relative group'>
                            <div className='absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-77 transition-opacity duration-300'></div> 
